...
const IPFSAlphabet = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"
...
func DecodeAlphabet(v, alphabet string) []byte {
	...
	var numZeros int
	for numZeros = 0; numZeros < len(v); numZeros++ {
		if v[numZeros] != alphabet[0] {
			break
		}
	}
